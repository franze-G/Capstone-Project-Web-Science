...
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-emerald text-start text-base font-medium text-emerald bg-emerald
focus:outline-none focus:text-emerald focus:bg-emerald focus:border-emerald transition duration-150
ease-in-out'
