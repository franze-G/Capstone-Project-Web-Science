<x-app-layout>
    <div class="m-10 text-white">
        <x-texts.title>@if (isset($team))
            {{ $team->name }} Dashboard
            @else
            {{ __('Overview') }}
            @endif</x-texts.title>

        <section class="flex flex-col md:flex-row border-b-2 border-slate-300/30 pb-4 m-4">
            <div class="flex flex-col w-full md:w-3/4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mt-6 mr-10 *:bg-zinc-500">
            ...
            <div class="flex flex-col w-full md:w-1/4 mt-6 md:mt-0">
                ...
                <div class="flex flex-col gap-3 mt-6 *:bg-zinc-500 overflow-y-auto h-[calc(100vh-45rem)]">
        ...
        <section class="flex flex-col md:flex-row border-b-2 border-slate-300/30 pb-4 m-4">
            <div class="flex flex-col w-full md:w-3/4">
                <div class="flex flex-col">
                    <h2 class="text-2xl font-semibold">Timeline of the Year</h2>
                    <p class="text-white/50">Set your appointments here</p>
                </div>
                <div class="flex flex-col gap-10 mt-6 mr-10">
                    <div>
                        Calendar Here
                    </div>
                </div>
