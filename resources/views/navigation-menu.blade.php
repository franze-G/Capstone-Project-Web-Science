<nav x-data="{ open: false }" class="bg-none">
                    ...
                    <x-dropdown align="right" width="60">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="w-60">
                                ...
                                <x-dropdown-link class="opacity-50 cursor-not-allowed">Team Settings</x-dropdown-link>
                                @else
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('client.freelance-display') }}"
                :active="request()->routeIs('client.freelance-display')">
                {{ __('Freelancers') }}
            </x-responsive-nav-link>
        ...
        <div class="mt-3 space-y-1">
            ...
            @else
            <x-responsive-nav-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}" 256
