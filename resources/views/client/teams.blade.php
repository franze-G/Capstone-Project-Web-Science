    ...
    <div class="m-10 text-white">
        ...
        <section class="flex flex-col border-b-2 border-slate-300/30 pb-4 m-4">
            <div class="flex flex-col">
                ...
                @else
                    <p class="text-white/50">Create a team to start managing</p>
                @endif
            </div>
            <!-- Team Switcher -->
                ...
                @if (auth()->user()->currentTeam)
                    <div class="flex self-end gap-2">
                        @if (Auth::user()->isClient() && auth()->user()->can('create', Laravel\Jetstream\Jetstream::newTeamModel()))
                            <x-buttons.a-button :href="route('teams.create')">create a new team</x-buttons.a-button>
        ...
        @if (auth()->user()->currentTeam)
            <!-- Team Owner -->
            <section
                class=" flex justify-between gap-10 items-start mb-6 m-4 border-b-2 border-slate-300/30 *:flex-col">
                ...
                <div class="flex justify-between w-1/4 items-end mb-4">
                    ...
                    <x-buttons.email-button
                        class="leading-tight text-gray-900">{{ auth()->user()->currentTeam->owner->email }}</x-buttons.email-button>
                </div>
            </section>
