<section>
    <div id="addTaskModal" class="fixed inset-0 items-center justify-center z-50 flex">
        <div class="bg-white p-8 rounded-xl shadow-lg w-1/2 text-black">
            ...
            <form action="{{ route('addtask.post') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end">
                    <button type="button" id="closeModalButton"
                        class="mr-4 px-4 py-2 bg-gray-300 rounded-xl">Cancel</button>
                    <button type="submit" id="addTaskModal" class="px-4 py1-2 bg-black text-white rounded-xl">Add
                        Task</button>
                </div>
            </form>
        </div>
