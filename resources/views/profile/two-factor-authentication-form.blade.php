<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4">
            ...
            <x-input id="code" type="text" name="code" class="block mt-1 w-1/2 text-black" inputmode="numeric" autofocus
        ...
        <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 rounded-xl">
