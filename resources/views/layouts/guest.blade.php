...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 flex-column antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-black">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-white shadow-md overflow-hidden sm:rounded-lg">
                <div class=" text-black text-center text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-8 md:mb-10 font-pearl;">Login</div>
                {{ $slot }}
