...
Route::prefix('clients-acc')->name('clients-acc.')->group(function () {
    ...
    //auth routes
    Route::middleware('auth:client-acc')->group(function () {
        Route::get('/dashboard', function () {
            return view('client.dashboard');
        })->name('dashboard'); //name gets the route from authseshcontroller
        ...
        //di pa sure tong mga naka comment out
